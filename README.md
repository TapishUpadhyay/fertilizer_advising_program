...
Nutrient Selection Interface
Three primary nutrient buttons (N, P, K) with color coding:
Nitrogen      - Vegetative growth
Phosphorus    - Root and flower development
Potassium     - Plant health and disease resistance

Recommendation Engine
Provides specific fertilizer recommendations based on selected nutrient
Includes NPK ratio information (e.g., Urea 46-0-0)
Offers alternative fertilizer options
Explains the role of each nutrient in plant growth
